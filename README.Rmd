...
The function does not return anything, however, all the results would be packed into *.RData* file and saved into current working directory. There are two elemnts in the resulting *.RData* object, **results_raw** records every single term/pathway tested, **results** contains significant results based on the prometers provided.
