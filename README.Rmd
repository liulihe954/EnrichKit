...
Here, six databases were build-in beforehand, users can simply indicate which database to use by providing a parameter - **Database = "xxx"** in the function arguments. 
...
As results, the function does not return any object in the environment, however, all the results would be packed into an *.RData* file and saved into the current working directory.
