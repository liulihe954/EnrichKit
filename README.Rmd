...
Note current release can only support **Bos Taurus**, other organism might be included in future release. Latest update 06-08-2020. 
...
As results, the function does not return any object in the R environment, however, all the results would be packed into an *.RData* file and saved into the current working directory.
...
- **ExternalLoss_total**: # of total genes **NOT** annotated in the database
- **ExternalLoss_sig**: # of significant genes **NOT** annotated in the database
