...
Objects resulted from last step (**GeneInfo**) could be fed into the subsequent loop processes. Here, six databases were build-in beforehand, users can simply indicate which database to use by providing parameter **Database = "xxx"** in the function body. 
